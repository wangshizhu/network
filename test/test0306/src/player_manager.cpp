...
{
	network::MessageCenter::GetInstancePtr()->RegisterHandler<Msg1, BuffMsgHandlerType>(1, std::tr1::bind(&PlayerManager::Msg1Handler, this, std::tr1::placeholders::_1, std::tr1::placeholders::_2), network::buff_proto);
	network::MessageCenter::GetInstancePtr()->RegisterHandler<Msg2, BuffMsgHandlerType>(2, std::tr1::bind(&PlayerManager::Msg2Handler, this, std::tr1::placeholders::_1, std::tr1::placeholders::_2), network::buff_proto);
	network::MessageCenter::GetInstancePtr()->RegisterHandler<MsgS2C0407, BuffMsgHandlerType>(3, std::tr1::bind(&PlayerManager::MsgS2C0407Handler, this, std::tr1::placeholders::_1, std::tr1::placeholders::_2), network::buff_proto);

	//network::MessageCenter::GetInstancePtr()->RegisterHandler<MsgC2S10, MsgPackMsgHandlerType>(10, std::tr1::bind(&PlayerManager::MsgC2S10Handler, this, std::tr1::placeholders::_1, std::tr1::placeholders::_2),network::msg_pack_proto);
}
